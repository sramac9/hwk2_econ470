...
knitr::include_graphics("submission2/Q1.png")
```
...
```{r}
knitr::include_graphics("submission2/Q2.png")
```
...
```{r}
knitr::include_graphics("submission2/Q3.png")
```
...
```{r}
knitr::include_graphics("submission2/Q4.png")
```

\newpage
\noindent 5. Calculate the average price among penalized versuquartos non-penalized hospitals.
